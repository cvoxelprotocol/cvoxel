...
export const CVoxelItem: FC<Props> = ({
  item,
  did,
  offchainItems,
  isOwner,
  ...
  return (
    <>
      <li
        className={
          "relative z-10 flex w-full items-center my-4 transition cursor-pointer"
        }
        onClick={handleClick}
      >
              ...
              <div className="flex items-center justify-around">
                <div className="w-fit max-w-full flex-auto pr-2">
                  <div className="flex w-full items-center justify-start space-x-2 ml-0.5">
                    <span
                      className={
                        "block px-1 py-0.5 text-xs rounded-full font-light w-max " +
                        (detailItem && detailItem.toSig && detailItem.fromSig
                          ? "text-[#53B15C] bg-green-200"
                          : "text-[#E83838] bg-red-300")
                      }
                    >
                      {detailItem && detailItem.toSig && detailItem.fromSig
                        ? "Verified"
                    ...
                    <p className="text-primary text-sm w-fit">
                      {convertTimestampToDateStr(item.issuedTimestamp)}
                    </p>
                  </div>
                    ...
                    {detailItem && (
                      <>
                        ...
                        <VerifierContainer
                          ...
                          address={
                            item.isPayer ? detailItem.to : detailItem.from
                          }
                        />
                        <a
