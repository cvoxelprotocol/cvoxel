...
export const InternalTransactionItem:FC<TransactionItemProps> = ({tx,internalTx}) => {
            ...
            <div className="sm:flex flex-auto justify-evenly items-center">
                <div className="flex justify-evenly items-center">
                    <div className="px-4 text-left">
                        <p className="break-words flex-wrap"><span className="text-gray-500">From: </span>{shortHash(internalTx.from, 8)}</p>
                    </div>
                    <div>
                        <FontAwesomeIcon className="w-3 h-3" icon={faArrowRight} color={'gray'}/>
                    </div>
                    <div className="px-4 text-left">
                        <p className="break-words flex-wrap"><span className="text-gray-500">To: </span>{shortHash(internalTx.to, 8)}</p>
                    </div>
                </div>
