...
export const InternalTransactionContainer: FC<
  InternalTransactionContainerProps
> = ({ tx, internalTxs, internalTxLoading }) => {
  return (
    <>
      {internalTxLoading && <CommonSpinner />}
      {!internalTxLoading && internalTxs && internalTxs.length > 0 && (
        <div className="mt-2 mb-3">
          <h3 className="font-semibold text-gray-500 text-left mb-2">
