            ...
            {files && (
                <>
                                    ...
                                    <div className="overflow-hidden border border-gray-100 rounded-lg w-1/4 h-auto md:w-32 md:h-32 p-1 m-1 mx-auto">
                                        <div className="flex min-w-0">
                                            {(file.file.type.indexOf('image') != -1) ? (
                                                ...
                                                <FontAwesomeIcon icon={faFileAlt} size={"2x"} className="block w-auto h-full mx-auto justify-center items-center text-center"/>
                                            )}
                                        </div>
                                    </div>
                    ...
                    {(status!=="uploading" && status!=="completed") && (
                        <button type="button" onClick={() => handleUpload()} className="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded inline-flex items-center mt-8">
