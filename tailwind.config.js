      ...
      colors: {
        ...
        light: {
          ...
          surface: {
            ...
            1: "rgba(247,239,250,1)",
            2: "rgba(244,232,248,1)",
            3: "rgba(241,224,247,1)",
            4: "rgba(240,222,246,1)",
            5: "rgba(238,217,245,1)",
            "opacity-0.7": "rgba(252, 252, 252, 0.7)",
          },
        ...
        dark: {
          ...
          surface: {
            DEFAULT: "rgba(30, 26, 30, 1)",
            1: "rgba(40,33,41,1)",
            2: "rgba(47,38,48,1)",
            3: "rgba(53,42,55,1)",
            4: "rgba(55,44,57,1)",
            5: "rgba(59,47,62,1)",
            "opacity-0.7": "rgba(30, 26, 30, 0.7)",
          },
